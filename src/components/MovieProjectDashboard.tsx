...
const QUALITY_LABEL: Record<string, string> = {
  sd: "SD 720p", hd: "HD 1080p", "4k": "4K Pro", "4k_ultimate": "🏆 ULTIMATE 4K", "8k_ultimate": "🏆 ULTIMATE 4K",
};
    ...
    <Card className="p-4">
      ...
      <div className="space-y-3">
        {projects.map(p => {
          ...
          const isUltimate = p.quality_tier === "4k_ultimate" || p.quality_tier === "8k_ultimate";
