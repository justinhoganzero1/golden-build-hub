...
import sample4k from "@/assets/quality-4k-sample.jpg";
 ...
 * member-only 4K photoreal render. Members still see it (informational).
 */
    ...
    <div className="mx-4 mb-4 rounded-2xl border border-amber-400/40 bg-gradient-to-br from-amber-500/10 via-background to-primary/10 p-4 shadow-[0_0_30px_rgba(245,158,11,0.15)]">
      <div className="flex items-start gap-2 mb-3">
        ...
        <div>
          ...
          <p className="text-xs text-muted-foreground mt-1 leading-relaxed">
            ...
            you'll need to join (just like Lovable). Members unlock unlimited <strong className="text-amber-300">true 4K photoreal</strong>.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3 mt-3">
        ...
        <figure className="relative rounded-xl overflow-hidden border border-amber-400/50 bg-muted/30 shadow-[0_0_20px_rgba(245,158,11,0.25)]">
          <img
            src={sample4k}
            alt="True 4K photoreal render sample"
            loading="lazy"
            width={400}
            height={400}
            className="w-full aspect-square object-cover"
          ...
          <figcaption className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/85 via-black/40 to-transparent p-2">
            <p className="text-[10px] font-bold text-amber-300 uppercase">True 4K Photoreal</p>
      ...
      <div className="mt-3 rounded-lg bg-background/60 border border-border/50 p-2.5">
        <p className="text-[10px] text-muted-foreground leading-relaxed">
          <strong className="text-amber-300">What's the 4K difference?</strong> 2.5D renders look great at thumbnail size but flatten under zoom — perfect for previews.
          True 4K resolves <strong className="text-foreground">individual hair fibers, micro-pores, iris flecks and dewdrop reflections</strong> — print-ready,
