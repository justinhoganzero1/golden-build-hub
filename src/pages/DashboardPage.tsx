...
const groups: TileGroup[] = [
  {
    ...
    tiles: [
      ...
      { label: "AI Council", icon: <Sparkles className="w-6 h-6" />, path: "/oracle?council=1" },
      { label: "Assistant", icon: <Star className="w-6 h-6" />, path: "/personal-assistant" },
  ...
  },
  {
    ...
    tiles: [
      ...
      { label: "Realm Builder", icon: <Sparkles className="w-6 h-6" />, path: "/realm-builder" },
      { label: "Public Realms", icon: <Globe className="w-6 h-6" />, path: "/realms" },
