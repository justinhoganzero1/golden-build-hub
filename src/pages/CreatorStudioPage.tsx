...
const CARDS: StudioCard[] = [
  {
    key: "photo",
    title: "Photo Studio",
    tagline: "4K AI photography, headshots, products & brand visuals.",
    bullets: ["Generate from text", "Edit your photos", "Up to 4K upscale"],
  ...
  },
  {
    ...
    bullets: ["Cinematic scenes", "Character bible", "1080p / 4K / 4K render"],
