...
const VARIANTS: Record<string, SeoVariant> = {
  "/ai-chat-companion": {
    ...
    description:
      "ORACLE LUNAR is a free AI chat companion you can talk to anytime — voice or text. Caring, smart, private. Install free, chat instantly.",
    ...
    faqs: [
      { q: "Is the AI chat companion free?", a: "Yes — ORACLE LUNAR is free to install and the core chat companion is free to use, every day." },
  ...
  "/ai-friend": {
    ...
    description:
      "Make an AI friend with ORACLE LUNAR. A caring virtual companion that listens, remembers, and chats 24/7 — completely free to start.",
    ...
    faqs: [
      { q: "Will my AI friend remember me?", a: "Yes — ORACLE LUNAR remembers your name, interests, and past conversations." },
  ...
  "/free-ai-chat": {
    ...
    description:
      "Chat free with ORACLE LUNAR AI — unlimited messages, voice chat, smart memory. The friendliest free AI chat app online.",
  ...
  "/ai-girlfriend": {
    ...
    description:
      "ORACLE LUNAR AI girlfriend: a caring, customizable virtual partner. Chat by text or voice, build a real bond. Free to start.",
  ...
  "/ai-boyfriend": {
    ...
    description:
      "ORACLE LUNAR AI boyfriend: thoughtful, caring, fully customizable. Voice or text chat, 24/7 — free to start.",
  ...
  "/character-ai-alternative": {
    ...
    description:
      "Looking for a Character AI alternative? ORACLE LUNAR offers free unlimited chat, voice, custom personalities and persistent memory.",
    ...
    faqs: [
      { q: "How is ORACLE LUNAR different from Character AI?", a: "Real voice chat, persistent memory, no waitlists, custom avatars, and a generous free tier." },
  ...
  "/ai-therapist-free": {
    ...
    description:
      "ORACLE LUNAR Mind Hub gives you a caring AI you can talk to about stress, anxiety, sleep, and tough days — free, private, 24/7.",
    ...
    faqs: [
      { q: "Is this real therapy?", a: "No — ORACLE LUNAR is supportive AI, not a licensed therapist. For crises, use the built-in Crisis Hub." },
  ...
  "/ai-image-generator-free": {
    ...
    keywords: ["free ai image generator", "ai photo generator", "ai art free", "4k ai images"],
    faqs: [
  ...
  "/ai-video-generator": {
    ...
    description: "ORACLE LUNAR Movie Studio turns text into cinematic AI videos. Script-to-scene, voice acting, soundtrack — all in one app.",
  ...
  "/ai-music-generator": {
    ...
    description: "Generate original music tracks from a text prompt. Royalty-free, commercial-use, free to start with ORACLE LUNAR.",
  ...
  "/ai-coder": {
    ...
    description: "Chat with ORACLE LUNAR Oracle Coder — your senior AI engineer. React, Three.js, Supabase, edge functions. Production-ready code.",
  ...
  "/ai-3d-app-builder": {
    ...
    description: "Build interactive 3D web apps with React Three Fiber. ORACLE LUNAR generates production-ready 3D scenes from a text prompt.",
  ...
  "/ai-business-idea-generator": {
    ...
    description: "Stuck for a business idea? Tell ORACLE LUNAR your skills and get a custom startup idea instantly. Free.",
  ...
  "/ai-horoscope-free": {
    ...
    description: "Get a personalized daily horoscope from ORACLE LUNAR AI. Specific, uplifting, free, no signup.",
  ...
  "/ai-companion-app": {
    ...
    description: "ORACLE LUNAR is the all-in-one AI companion app: chat, voice, wellness, safety. Free to install on iPhone, Android, desktop.",
  ...
  "/replika-vs-oracle-lunar": {
    path: "/replika-vs-oracle-lunar",
    title: "Replika vs ORACLE LUNAR — Free Alternative Comparison",
    description: "Side-by-side: Replika vs ORACLE LUNAR. ORACLE LUNAR wins on free voice chat, persistent memory, no paywall on basics.",
    h1: "Replika vs ORACLE LUNAR",
    tagline: "Free voice chat. Free memory. No paywall on basics.",
    keywords: ["replika vs oracle-lunar", "replika comparison", "best replika alternative"],
    faqs: [
      { q: "Is voice chat free?", a: "Yes in ORACLE LUNAR — Replika locks it behind Pro." },
    ],
  },
  "/ai-life-coach-free": {
    path: "/ai-life-coach-free",
    title: "Free AI Life Coach — Goals, Habits, Mindset",
    description: "ORACLE LUNAR AI life coach helps you set goals, build habits, and stay motivated. Voice chat, daily check-ins, free.",
  ...
  "/ai-elderly-care": {
    ...
    description: "ORACLE LUNAR Elderly Care: easy voice chat, medication reminders, emergency button, family hub. Free to start.",
  ...
  "/ai-crisis-support": {
    ...
    description: "ORACLE LUNAR Crisis Hub: free 24/7 AI support for tough moments, with direct hotline shortcuts. Always available.",
    ...
    faqs: [
      { q: "Is this an emergency service?", a: "No — for emergencies call 000 (AU), 911 (US), or your local hotline. ORACLE LUNAR provides supportive AI conversation." },
    ],
  },
  "/ai-photo-editor": {
    path: "/ai-photo-editor",
    title: "AI Photo Editor — Free Image Transformations",
    description: "ORACLE LUNAR Photography Hub: AI image-to-image transforms, background removal, style transfer. Free to start.",
    h1: "AI Photo Editor",
  ...
  "/free-seo-tools": {
    ...
    description: "Free ORACLE LUNAR AI SEO tools: title tag, meta description, schema markup, keyword ideas. No signup needed.",
  ...
  "/ai-email-writer": {
    ...
    description: "ORACLE LUNAR AI email writer: marketing, sales, follow-ups, cold outreach. Free, no signup needed.",
    ...
    <>
      ...
      <main className="min-h-screen bg-background text-foreground">
        ...
        <section className="container mx-auto px-4 py-12 max-w-3xl">
          <h2 className="text-2xl md:text-3xl font-bold mb-6 text-center">Why people choose ORACLE LUNAR</h2>
