...
const SEG = [
  ...
  { id: 1, s: "o", mode: "studio", plate: true, gapAfter: 0.5, text:
    "Before we start, one thing, straight up. Everything you're about to see is for entertainment purposes only. None of these thoughts, none of these scenes, none of these people are real. And that includes me. I am not a real presenter. I'm an A.I. host, my face, my voice and every word I say were generated by artificial intelligence inside Oracle Lunar, at oracle dash lunar dot online. Nobody was hurt, nothing happened, it's a story. Right. Now let's get into it." },

  { id: 2, s: "o", mode: "corner", img: 0, gapAfter: 0.2, text:
    "This is Scam the Scammer, Juzzy Style. Three minutes of a twenty chapter Aussie revenge thriller written by A.I., illustrated by A.I., narrated by A.I. and cut into a film by A.I., all inside oracle dash lunar dot online. Not a single camera was ever switched on." },
  ...
  { id: 21, s: "o", mode: "corner", img: 38, gapAfter: 0.3, text:
    "And every face you've seen so far, including the bloke I'm about to interview, is an A.I. character built in Oracle Lunar. Watch what happens when two A.I. avatars talk to each other, live." },
  ...
  { id: 15, s: "o", mode: "corner", img: 40, gapAfter: 0.15, text:
    "That interview never happened. Neither did he, and neither do I. Both faces, both voices, the lip sync, the score and every scene behind me were generated by A.I. in Oracle Lunar. One app. Oracle dash lunar dot online." },
  { id: 16, s: "o", mode: "studio", plate: true, gapAfter: 0.15, text:
    "Twenty chapters, thirty six thousand words, forty two illustrations, a full narrated cut, and this hosted preview with an A.I. presenter. One prompt, one afternoon, one tool. Oracle Lunar did all of it." },
  { id: 17, s: "o", mode: "studio", plate: false, gapAfter: 0.9, text:
    "Your story, your cast, your A.I. host, in your voice. Write yours at oracle dash lunar dot online. I'm Olivia Vance, artificial from the hair down. Entertainment only, remember. Goodnight." },
];
